...
| `cddl-check` | `crates/cddl-check` | Validates JSON against the profile's CDDL module (the subset of RFC 8610, RFC 9165 and RFC 9741 it uses); a test tool, not published |
